defmodule Challenge.Root do
  ...
  def init(_opts) do
    ...
    ureg_name = :"Challenge.User.Registry.#{dt}.#{rnd}"
    treg_name = :"Challenge.Transaction.Registry.#{dt}.#{rnd}"
    part_name = :"Challenge.Partitioner.#{dt}.#{rnd}"
      ...
      |> Enum.reduce([], fn u, for_retry ->
        started =
          DynamicSupervisor.start_child(
            ...
            {Challenge.User, [usr_reg: ureg, txn_reg: treg, name: u]}
          )
